using ApiClass.Comandos.Personas;
using ApiClass.Data;
...
using System.Net;
using ApiClass.Bussines.Personas;
...
namespace ApiClass.Controllers
{
    ...
    public class PersonaController : ControllerBase
    {
        ...
        public async Task<ListadoPersonas> GetPersonasById(int id)
        {
            var resultado = await _mediator.Send(new GetByIdBussines.GetPersonasByIdComando
            {
                IdPersona = id
            });
            return resultado;
        ...
        public async Task<ListadoPersonas> PutPersona([FromBody] UpdatePersonas comando)
        {
            var result = new ListadoPersonas();
            // validaciones TODO
